---
title: LES DETERMINANTS DE L'ABANDON DU TRAITEMENT ANTIRETROVIRAL CHEZ LES PERSONNES
  VIVANT AVEC LE VIH/SIDA DANS LA REGION MINIERE DE BOKE (GUINEE)
author: ' '
date: "2025-11-04"
output:
...
explicative <- c("sexe_patient", "classe_age", "niveau_inst", "profession", "revenus_mensuel",
                 "distance_cta", "duree_trajet", "mode_transport", "raison_effets_secondaires",
                 "raisons_distance", "raisons_financiers", "raisons_stigmatisation",
                 "raisons_rupture_arv", "autre_raisons_itarv", "formation_sensibilisation_vih_arv",
                 "arret_tarv_nocif", "victime_stigmatisation",
                 "freq_visites_cta", "on_vie_longtemps_avec_vih", "jugement_de_statut")
...
**Figure 1: desription des participants selon le centre de traitement fréquenté **





**Tableau I: desription des participants selon le sexe, l'age la situation matrimoniale,le niveau d'instruction et la profession**
...
**Tableau II: desription des participants selon le revenus_mensuel, la distance parcouru et  durée du trajet et le mode de transport**
...
**Tableau III: desription des participants selon l'interruption du traitement, le nombre de fois de l'interruptionet la durée de la dernière interruption**
...
**Tableau IV: desription des participants selon les raisons de l'interruptionet**
```{r }
...
**Tableau V: desription des participants selon qu'ils soient sous traitement ou non et les raisons**
```{r }
...
**Tableau VI: Classe d'age selon le sexe**
...
**Tableau VII: Age moven en fontion du sexe**
...
**Tableau VIII: Analyse bivarié abandon de traitemet aux variables de caractéristiques demographiques**
...
**Tableau IX: Analyse bivarié abandon de traitemet aux variables de caractéristiques de revenu mensuel**
...
**Tableau X: Analyse bivarié abandon de traitemet aux variables de d'interruption de de sa frquence dans le temps**
...
**Tableau XI: Analyse bivarié abandon de traitemet par rapports aux variables des reaisons de d'interruption dans le temps**
...
**Tableau XII: Analyse bivarié abandon de traitemet par rapports aux variables de facteurs d'abandon de traitement **
...
**Tableau XIII: Analyse des facteurs associés à l'abandon de traitemet : regression logistique simple**
...
```
 ...
 l’AUC (Area Under the Curve) de la courbe ROC est 0.9485, ce qui est excellent. Elle distingue très bien les deux classes (abandon ARV vs non-abandon).



**Tableau XIV: Analyse des facteurs associés à l'abandon de traitemet : regression logistique mulutiple **

```{r }

tbl_merge<- tbl_merge(list(univ_tab, mv_tab), tab_spanner = c("Univariate", "Multivariable"))
